  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        addLog("CRITICAL FAILURE: Unknown error");
      }
    }
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {selectedCategoryImages.map((img) => (
                  <div
                    ...
                    className={`relative aspect-square cursor-pointer group border ${selectedToDelete.includes(img.id) ? "border-red-500 opacity-50" : "border-green-900 hover:border-green-500"
